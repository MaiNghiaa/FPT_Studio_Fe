  ...
  return (
    <div className="bg-[#f8f9fa]">
      ...
      <div className="box-container w-full max-w-[1200px] py-0 px-3 relative my-0 mx-auto">
        <p className="title text-xl font-medium text-[#32373d] mb-6">WORKSHOP SẮP DIỄN RA</p>
        <div className="wrap-item flex flex-wrap mb-6 justify-start">
          <a href="" className="cursor-pointer w-[33%] max-w-[376px] rounded-md overflow-hidden shadow-[0_1px_4px_0_#0a0a0a26]">
              <div className="img-item w-full max-w-[776px] mr-6">
                <img src="" alt="" className="w-[376px] h-[211.44px] object-cover border-none"/>
              </div>
              <div className="text-item mx-[12px] mt-2 mb-3">
                <div className="text-[18px] leading-6 font-medium text-[#32373d] mb-1">
Workshop Shot on iPhone 15 - Dựng video chuyên nghiệp cùng chuyên gia</div>
              ...
              <div className="time flex  items-center justify-start">
                <div className="day flex mr-5 items-center relative dot">
                  ...
                  <div className="text-[14px] leading-5 text-[#6a737a]">Chủ Nhật, 31/03/2024</div>
                </div>
                <div className="hour mr-5 items-center flex">
                  <i className="text-[16px] mr-1 text-[#939ca3] ic-line-time"></i>
                  <div className="text-[14px] leading-5 text-[#6a737a]">03:00 - 05:00</div>
                </div>
              </div>
              </div>
          </a>
      ...
      <div className="box-container w-full max-w-[1200px] py-0 px-3 relative my-0 mx-auto">
      <p className="title text-xl font-medium text-[#32373d] mb-6">WORKSHOP ĐÃ DIỄN RA</p>
    <div className="happened">
      <div className="flex flex-wrap justify-start mb-6 gap-6">
        <a href="" className="w-[33%] max-w-[376px] rounded-md overflow-hidden shadow-[0_1px_4px_0_#0a0a0a26]">
          <div className="img-item w-full max-w-[776px] mr-6">
                <img src="" alt="" className="w-[376px] h-[211.44px] object-cover border-none"/>
              </div>
              <div className="text-item mx-[12px] mt-2 mb-3">
